...
static const _LedControl_Request_type_support_symbol_names_t _LedControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, LedControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duckie_interfaces, srv, LedControl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, duckie_interfaces, srv, LedControl_Request)() {
  return &::duckie_interfaces::srv::rosidl_typesupport_c::LedControl_Request_message_type_support_handle;
}
...
static const _LedControl_Response_type_support_symbol_names_t _LedControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, LedControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duckie_interfaces, srv, LedControl_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, duckie_interfaces, srv, LedControl_Response)() {
  return &::duckie_interfaces::srv::rosidl_typesupport_c::LedControl_Response_message_type_support_handle;
}
...
static const _LedControl_type_support_symbol_names_t _LedControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, LedControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, duckie_interfaces, srv, LedControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, duckie_interfaces, srv, LedControl)() {
  return &::duckie_interfaces::srv::rosidl_typesupport_c::LedControl_service_type_support_handle;
}
