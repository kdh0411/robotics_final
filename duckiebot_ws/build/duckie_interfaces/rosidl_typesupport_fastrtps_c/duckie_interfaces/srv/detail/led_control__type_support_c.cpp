...
#include "duckie_interfaces/srv/detail/led_control__rosidl_typesupport_fastrtps_c.h"
...
using _LedControl_Request__ros_msg_type = duckie_interfaces__srv__LedControl_Request;
...
size_t get_serialized_size_duckie_interfaces__srv__LedControl_Request(
  const void * untyped_ros_message,
...
static uint32_t _LedControl_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_duckie_interfaces__srv__LedControl_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckie_interfaces
size_t max_serialized_size_duckie_interfaces__srv__LedControl_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = duckie_interfaces__srv__LedControl_Request;
    is_plain =
      (
...
static size_t _LedControl_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckie_interfaces__srv__LedControl_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, LedControl_Request)() {
...
using _LedControl_Response__ros_msg_type = duckie_interfaces__srv__LedControl_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckie_interfaces
size_t get_serialized_size_duckie_interfaces__srv__LedControl_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LedControl_Response__ros_msg_type * ros_message = static_cast<const _LedControl_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_duckie_interfaces__srv__LedControl_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_duckie_interfaces
size_t max_serialized_size_duckie_interfaces__srv__LedControl_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = duckie_interfaces__srv__LedControl_Response;
    is_plain =
      (
...
static size_t _LedControl_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_duckie_interfaces__srv__LedControl_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, LedControl_Response)() {
...
// already included above
// #include "duckie_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "duckie_interfaces/srv/led_control.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, duckie_interfaces, srv, LedControl)() {
