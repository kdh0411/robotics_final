...
class Metaclass_LedControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'duckie_interfaces.srv.LedControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from duckie_interfaces.srv import _led_control
...
class LedControl(metaclass=Metaclass_LedControl):
    from duckie_interfaces.srv._led_control import LedControl_Request as Request
    from duckie_interfaces.srv._led_control import LedControl_Response as Response
